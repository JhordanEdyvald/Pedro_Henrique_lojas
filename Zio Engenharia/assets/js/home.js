$(document).ready(function () {
    // add steps from jobs
    {
        ...
        const jobs = [
            {
                icon: 'bi bi-rulers',
                title: 'Planejamento e projeto integrado.',
                description:
                    'Desenvolvemos projetos com foco técnico e viabilidade, alinhando escopo, custo e prazo para a obra.'
            },
            {
                icon: 'bi bi-diagram-3',
                title: 'Orçamento e cronograma detalhados.',
                description:
                    'Definimos materiais, etapas e prazos com clareza para uma execução eficiente e sem surpresas.'
            },
            {
                icon: 'bi bi-shield-check',
                title: 'Execução com alto padrão.',
                description:
                    'Equipe qualificada e responsabilidade técnica asseguram qualidade, segurança e acabamento superior.'
            },
            {
                icon: 'bi bi-clipboard-check',
                title: 'Gerenciamento e entrega técnica.',
                description:
                    'Acompanhamento de obra, controle de qualidade e entrega conforme projeto — do início ao fim.'
            }
        ];
